		    ...
		    <tr> 
		      ...
		      <td>
					<div class="input-group mb-2">
						...
						<div class="alert alert-success form-control" role="alert" name="" id="">nome</div>
 					</div>
					<div class="input-group mb-2">
						<div class="input-group-prepend">
							<span class="input-group-text"  >Type :</span>
						</div>
						<div class="alert alert-success form-control" role="alert" name="" id="">Type</div>
					</div>
					<div class="input-group mb-2">
						<div class="input-group-prepend">
							<span class="input-group-text"  >Number of children allowed :</span>
						</div>
						<div class="alert alert-success form-control" role="alert" name="" id="">10</div>
					</div>
